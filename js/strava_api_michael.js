/*
    Client ID: 162250 
    Client Secret: 730145084c5ba6dce48c112dee1156c426ee951c 
    Your Access Token: 0cbb62bb94e09d6ae2032e5b943dcdf482d1a1a0 
        - Scope: Read
        - Expires every 6 hours

    Your Refresh Token: ba9ef5368acfed0dbe0369a1167cd9ecde3bc009 
        - Scope: Read
...
Paste the below code in a browser, hit enter then grab the "code" part from the resulting url.
    ...
    - Response: http://localhost/exchange_token?state=&code=19465f263398b30e9037dd6c38c98927bf54d5b5&scope=read,activity:read,read_all
...
2) Exchange authorization code for access token & refresh token
   ...
   https://www.strava.com/oauth/token?client_id=162238&client_secret=526b6989b62616ce1416f27e0414866958666013&code=5185af05044cf011130ff8c018e5fef290d9d377&grant_type=authorization_code
        "token_type": "Bearer",
        "expires_at": 1748643176,
        "expires_in": 21599,
        "refresh_token": "b769e8affe3469c2acf39bfca5752ef06fea5f1d",
        "access_token": "44766a840929ca02c1ecf2c72ebd3e2dc3c0e1e1",

3) View your activities using the access token just received

    https://www.strava.com/api/v3/athlete/activities?access_token=44766a840929ca02c1ecf2c72ebd3e2dc3c0e1e1
...
http://www.strava.com/oauth/authorize?client_id=162238&response_type=code&redirect_uri=http://localhost/exchange_token&approval_prompt=force&scope=read
...
function reAuthorize(){
    fetch(auth_link, {
        ...
        body: JSON.stringify({
            client_id: '162250',
            client_secret: '730145084c5ba6dce48c112dee1156c426ee951c',
            refresh_token: 'b769e8affe3469c2acf39bfca5752ef06fea5f1d',
            grant_type: 'refresh_token'
        })
    }).then(res => res.json())
