/*
    Client ID: 162238
    Client Secret: 526b6989b62616ce1416f27e0414866958666013
    Your Access Token: a47680f64bf3ebcfd5faec6751ae4ab894ca81f3
        - Scope: Read
        - Expires every 6 hours

    Your Refresh Token: 2010b94e44ddb45370a1a1b1f83cb0f644819953
        - Scope: Read
...
Paste the below code in a browser, hit enter then grab the "code" part from the resulting url.
    ...
    https://www.strava.com/oauth/authorize?client_id=162238&response_type=code&redirect_uri=http://localhost/exchange_token&approval_prompt=force&scope=read_all,activity:read
    - Response: http://localhost/exchange_token?state=&code=5185af05044cf011130ff8c018e5fef290d9d377&scope=read,activity:read,read_all
...
2) Exchange authorization code for access token & refresh token
   ...
   https://www.strava.com/oauth/token?client_id=162238&client_secret=526b6989b62616ce1416f27e0414866958666013&code=5185af05044cf011130ff8c018e5fef290d9d377&grant_type=authorization_code
        "token_type": "Bearer",
        "expires_at": 1748642212,
        "expires_in": 21599,
        "refresh_token": "23227cb9c49a632130451aa2206241479b6dd842", // 6ce920762a92619324899932cca36fd33a90e119
        "access_token": "5a2fb3ae5d4fb0db6f172dd87237fc3c479d0eed", // ca9b39005d79bb3484db3dfabfa6dd3549681ece

3) View your activities using the access token just received

    https://www.strava.com/api/v3/athlete/activities?access_token=a47680f64bf3ebcfd5faec6751ae4ab894ca81f3

4) Use refresh token to get new access tokens

    https://www.strava.com/oauth/token?client_id=43978&client_secret=23b6714754f8bbc59b8535d699bd5ce8e78cc9d6&refresh_token=d37dd266be8916923ff2d1b50ca7811bbfdcc232&grant_type=refresh_token
...
/*------------------------------------------------------------------------------------------------------------------*/
/*----- Main Function to Return and Transform Activity Data --------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------------------*/
...
async function getActivities(res){
    ...
    //var map = L.map('map').setView([43.0722, -89.4008], 12); // Sets where map is centered
    //var map = L.map('map').setView([setLat, setLong], 12); // Sets where map is centered
...
function reAuthorize(){
    fetch(auth_link, {
        ...
        body: JSON.stringify({
            client_id: '216000',
            client_secret: '1cf9ccdbac63f92e3c62991df61b030bf1329f47',
            refresh_token: '6ce920762a92619324899932cca36fd33a90e119',
            grant_type: 'refresh_token'
        })
    }).then(res => res.json())
        .then(res => getActivities(res))
