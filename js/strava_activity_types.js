(function (root, factory) {
    ...
    const ACTIVITY_TYPE_CATALOG = [
        ...
        { key: 'iceskate', label: 'Ice Skate', color: '#ce5f5f', categoryKey: 'iceskate', categoryLabel: 'Ice Skate', dailyGroup: 'other', aliases: ['IceSkate'] },
        ...
        { key: 'kitesurf', label: 'Kitesurf', color: '#e4932c', categoryKey: 'kitesurf', categoryLabel: 'Kitesurf', dailyGroup: 'other', aliases: ['Kitesurf'] },
        ...
        { key: 'sail', label: 'Sail', summaryLabel: 'Sailing', color: '#8a7576', categoryKey: 'sail', categoryLabel: 'Sailing', dailyGroup: 'other', aliases: ['Sail', 'Sailing'] },
        ...
        { key: 'standuppaddling', label: 'Paddleboarding', color: '#0f4fa3', categoryKey: 'standuppaddling', categoryLabel: 'Paddleboarding', dailyGroup: 'other', aliases: ['StandUpPaddling', 'Stand Up Paddling', 'Paddleboarding', 'Paddleboard', 'SUP'] },
        { key: 'surf', label: 'Surf', summaryLabel: 'Surfing', color: '#ffde71', categoryKey: 'surf', categoryLabel: 'Surfing', dailyGroup: 'other', aliases: ['Surfing', 'Surf'] },
