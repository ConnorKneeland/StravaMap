...
const intervalsActivitySchema = new mongoose.Schema({
    ...
    import_source: { type: String, index: true },
    source_activity_id: { type: String },
    source_filename: { type: String },
    source_datapoint_count: { type: Number, default: 0 },
    source_stream_count: { type: Number, default: 0 },
    data_richness_score: { type: Number, default: 0 },
    export_imported_at: { type: Date },
    export_metadata: { type: Mixed },
    ...
    dedupe_group_key: { type: String, index: true },
    dedupe_hidden: { type: Boolean, default: false, index: true },
    preferred_activity_key: { type: String },
    dedupe_sources: { type: [Mixed], default: void 0 },
